...
// Tato funkce zobrazuje možnosti otázek a odpovědí pro aktuální index otázek z pole otázek na stránce.
// Vytvoří značku HTML pro možnosti otázky a odpovědi pomocí dat z objektu otázky a poté je přidá na stránku.
// Každá možnost je navíc nastavena na atribut onclick, který ji váže k funkci optionSelected, takže možnost zvolená uživatelem lze později sledovat.
...
// Zobrazí výsledek uživateli, který byl přijat během testu.
...
// Funkce queCounter(n) a startTimer(time) a startTimerLine(time) pro zobrazení čítačů a časovače na stránce.
...
// startTimer(time) - funkce spustí časovač s odpočítáváním po zadaný počet sekund.
// Pokud čas vyprší, funkce zobrazí správnou odpověď a vypne všechny zbývající možnosti odpovědi, takže uživatel nemůže vybrat jinou odpověď.
// Funkce také zobrazuje tlačítko "Next" pro přechod na další otázku.
...
// startTimerLine(time) - funkce spustí řádek časovače, který zobrazuje průběh kvízu.
// Čára časovače se zaplní až do konce za 550 jednotek času (určeno v milisekundách) a poté se zastaví.
...
// queCounter(index) - Funkce zobrazuje aktuální počet otázek a celkový počet otázek ve spodní části obrazovky.
...
// questionImage.src = 'https://about-history.com/wp-content/uploads/2017/07/celts-scaled.jpg';

// quiz_box.appendChild(questionImage);

// document.body.appendChild(quiz_box)}
